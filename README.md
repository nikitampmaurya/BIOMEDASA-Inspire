...
- **LEGO robot activity** — students program [LEGO SPIKE Prime robots](https://spike.legoeducation.com/prime/lobby/), finishing with an open-ended challenge to build their own program (e.g. making the robot dance/move, respond to sensors, play music, light up and flash).
